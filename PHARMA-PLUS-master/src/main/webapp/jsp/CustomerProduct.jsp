...
<%@page import="com.protech.sportszone.dto.Product"%>
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="https://cdn.pixabay.com/photo/2016/09/17/23/52/fitness-1677212_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
			<div class="carousel-item">
				<img src="https://cdn.pixabay.com/photo/2016/11/19/19/34/home-fitness-equipment-1840858_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
			<div class="carousel-item">
				<img src="https://cdn.pixabay.com/photo/2016/11/29/13/08/skateboard-1869727_640.jpg" class="d-block w-100" alt="..."
					height="500em">
			</div>
		</div>
	</div>
