...
<head>
    ...
    * {
    ...
    body{
	background-image: url("https://cdn.pixabay.com/photo/2017/07/02/19/24/dumbbells-2465478_1280.jpg");
...
${fail}
    ...
    <form action="/customer/signup" method="post" style="background-image: linear-gradient(to bottom right,rgb(187, 170, 170),rgb(243, 127, 127))">
